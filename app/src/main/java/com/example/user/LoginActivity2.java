...
import com.example.user.helper.DatabaseHandler;
import com.example.user.helper.Functions;
import com.example.user.helper.SessionManager;
...
//        });
        ...
        loginY_N = findViewById(R.id.staylogin);
    ...
    private void init() {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                // Hide Keyboard
                Functions.hideSoftKeyboard(LoginActivity2.this);
        ...
        String loginY_N = sharedPreferences.getString(getResources().getString(R.string.prefLoginState), "");

        if (loginY_N.equals("logged in")) {
        ...
        btnLinkToRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(LoginActivity2.this, RegPage.class);
                startActivity(i);
            }
        });
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(Integer.parseInt(json_user.getString("verified")) == 1){
                            ...
                            Intent upanel = new Intent(LoginActivity2.this, HomeActivity.class);
                            ...
                            Intent upanel = new Intent(LoginActivity2.this, EmailVerify.class);
                            upanel.putExtras(b);
                            upanel.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(upanel);
                            finish();
                        ...
                        Intent login_tryagain = new Intent(LoginActivity2.this, LoginActivity2.class);
                        startActivity(login_tryagain);
                    }
