                ...
                try {
                    ...
                    if (!error) {
                        ...
                        if(Integer.parseInt(json_user.getString("verified")) == 1){
                            ...
                            Intent upanel = new Intent(MainActivity.this, HomeActivity.class);
                            ...
                            Intent upanel = new Intent(MainActivity.this, EmailVerify.class);
                            upanel.putExtras(b);
                            upanel.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(upanel);
                            finish();
...
//
//    public void on_profile_click(View view) {
//        Intent intent = new Intent(this, ProfilePage.class);
//        startActivity(intent);
//    }
//
//    public void on_donation(View view){
//        startActivity(new Intent(MainActivity.this, IntroActivity.class));
//    }
//}

  /*  public void Charity(View view){
       //startActivity(new Intent(MainActivity.this, com.example.user.CharitiesDatabase.class));
    }


    public void on_donations_click(View view){
        startActivity(new Intent(MainActivity.this, CalendarActivity.class));
}
    public void on_volunteers_click(View view){
