...
public class RegPage extends AppCompatActivity {
    private static final String TAG = RegPage.class.getSimpleName();
    ...
    private void init() {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Hide Keyboard
                Functions.hideSoftKeyboard(RegPage.this);
        ...
        btnLinkToLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(RegPage.this, LoginActivity2.class);
                startActivity(i);
                finish();
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent i = new Intent(RegPage.this, EmailVerify.class);
